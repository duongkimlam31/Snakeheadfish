...
class King : public Chesspiece {
 ...
 public:
  ...
  King(std::string name, std::string team, std::string position,
       int points = 0) {
    this->name = name;
    this->team = team;
    this->points = points;
  ...
  void setCastleLeft(bool castle_left) { this->castle_left = castle_left; }

  void setCastleRight(bool castle_right) { this->castle_right = castle_right; }

  bool getMoved() { return this->moved; }

  bool getCastleLeft() { return this->castle_left; }

  bool getCastleRight() { return this->castle_right; }
