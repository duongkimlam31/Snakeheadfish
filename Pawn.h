        ...
        void generateMoves(const std::unordered_map<std::string, std::string> occupiedCells) override{
            ...
            if (this->team == "white"){
                ...
                if (row > 0 && col > 0){
                    ...
                    if (occupiedCells.find(attackCell) != occupiedCells.end() && occupiedCells.find(attackCell)->second == "black"){
                ...
                if (row < 7 && col <= 7){
                    ...
                    attackCell += char(int(col_name)-1);
                    attackCell += char(int(row_name)-1);
                    if (occupiedCells.find(attackCell) != occupiedCells.end() && occupiedCells.find(attackCell)->second == "white"){
                        this->availableMoves.push_back(attackCell);
                    }
                }
                if (row < 7 && col >= 0){
