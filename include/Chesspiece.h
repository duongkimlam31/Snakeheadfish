...
class Chesspiece {
 ...
 public:
  virtual void generateMoves(
      const std::unordered_map<std::string, std::string> occupiedCells) = 0;
  virtual bool changeColor() { return false; }
  virtual ~Chesspiece(){};
  ...
  std::vector<std::string> getAvailableMoves() { return this->availableMoves; }
  ...
  void removeAllMoves() { this->availableMoves.clear(); }
